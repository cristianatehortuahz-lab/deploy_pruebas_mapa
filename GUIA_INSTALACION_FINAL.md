...
Este documento detalla los pasos definitivos para instalar y configurar el Mapa de Colaboración Interactivo v4.2+ (con la red dividida por Publicaciones y Proyectos) en un servidor de Producción VIVO, incluyendo la configuración de la Caché automatizada nocturna.
